    ...
    while(i>0){
        ...
        //If no start game
            ...
            while (roll<=13){
                ...
                //cout<<"Would you like to re-roll any dice? If so, put the number you want to re-roll:"<<endl;
                //Check that the user doesn't pick a saved value
                if(pick==temp1||pick==temp2||pick==temp3){
                    cout<<"You have already chosen this category, pick another option."<<endl;
                    cout<<endl;
                    //Table for dice
                    cout<<"Dice Number: 1 | 2 | 3 | 4 | 5"<<endl;
                    //Show user dice
                ...
                //Options
                //Check that the user doesn't pick Ones a second time
                if (pick=='1'){
