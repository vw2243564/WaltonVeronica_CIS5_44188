...
void srtAry(int[],int);//Sort Function
...
int main(int argc, char** argv) {
    ...
    ifstream inHigh("NumScores.txt");//Numbers of high scores
    ...
    do{
        ...
        switch(choice){
            ...
            case '3': {
                ...
                int nums=0;
                while(inHigh>>scrAry[nums]){
                    nums++;
                }                
                
                srtAry(scrAry,3);
                cout<<endl;
                cout<<"Scores in order:\n";
                for(int i=0;i<3;i++){
                    cout<<scrAry[i]<<" ";
                }
            };break;
            case '4':{
                ...
                cout<<"You didn't get a zero in any categories, good job!"<<endl;
                    ...
                    cout<<"You received a zero in a category! Try not to next time!"<<endl;
                }
            };break;
            default:{
