...
void outHigh(ofstream &,int,string);//Output High Scores
void outStat(ofstream &,int,string,int[][COLS]);//Output Game Stats
...
int main(int argc, char** argv) {
    ...
    if(in.is_open()) cout<<" File is open"<<endl;
   ...
   //Show menu and loop
    ...
    //Output to file
    outHigh(out,score,name);
    outStat(outSt,score,name,scrTemp);
...
void outHigh(ofstream &out,int score,string name){//High Scores
...
void outStat(ofstream &out,int score,string name,int total[][COLS]){
